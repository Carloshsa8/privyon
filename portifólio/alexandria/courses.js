...
const courses = [
    {
        ...
        price: 297, minPrice: 297, idealPrice: 370, idealPrice: 370, maxPrice: 445,
        originalPrice: 497,
        category: "Notion",
    ...
    },
    {
        ...
        price: 347, minPrice: 347, idealPrice: 430, maxPrice: 520,
        originalPrice: 547,
        category: "Automação",
    ...
    },
    {
        ...
        price: 247, minPrice: 247, idealPrice: 310, maxPrice: 370,
        originalPrice: 397,
        category: "Google",
    ...
    },
    {
        ...
        price: 197, minPrice: 197, idealPrice: 250, maxPrice: 295,
        originalPrice: 347,
        category: "IA",
    ...
    },
    {
        ...
        price: 397, minPrice: 397, idealPrice: 490, maxPrice: 595,
        originalPrice: 597,
        category: "Google",
    ...
    },
    {
        ...
        price: 147, minPrice: 147, idealPrice: 180, maxPrice: 220,
        originalPrice: 247,
        category: "Notion",
    ...
    },
    {
        ...
        price: 447, minPrice: 447, idealPrice: 550, maxPrice: 670,
        originalPrice: 697,
        category: "IA",
    ...
    },
    {
        ...
        price: 97, minPrice: 97, idealPrice: 120, maxPrice: 145,
        originalPrice: 147,
        category: "Produtividade",
...
function getCourses() {
    if (typeof DB !== 'undefined' && DB.getCourses) return DB.getCourses().filter(c => c.published);
    return courses.filter(c => c.published);
}

function getAllCourses() {
    if (typeof DB !== 'undefined' && DB.getCourses) return DB.getCourses();
    return courses;
}

function getCourseById(id) {
    if (typeof DB !== 'undefined' && DB.getCourses) return DB.getCourses().find(c => c.id === parseInt(id));
    return courses.find(c => c.id === parseInt(id));
}

function getCoursesByInstructor(instructorId) {
    if (typeof DB !== 'undefined' && DB.getCourses) return DB.getCourses().filter(c => c.instructorId === instructorId);
    return courses.filter(c => c.instructorId === instructorId);
}

function getFeaturedCourses() {
    if (typeof DB !== 'undefined' && DB.getCourses) return DB.getCourses().filter(c => c.featured && c.published);
